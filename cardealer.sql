...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2025 at 10:19 AM
...
INSERT INTO `user` (`role`, `id_user`, `nama`, `no_telp`, `password`, `username`) VALUES
('SALES', 1, 'Syahra Rizky', '081210101010', '$2a$10$jD8Vrr/WcARqvxVxnkbhtufh6pd.yBOciEkMQZSKgmBE3UlfOAj.a', 'syahra'),
('PETUGAS', 2, 'Nurul Izzah', '0812341234', '$2a$10$jD8Vrr/WcARqvxVxnkbhtufh6pd.yBOciEkMQZSKgmBE3UlfOAj.a', 'icha'),
('SALES', 3, 'Qualifia', '081234567890', '$2a$10$jD8Vrr/WcARqvxVxnkbhtufh6pd.yBOciEkMQZSKgmBE3UlfOAj.a', 'lifia'),
('PETUGAS', 4, 'Rafi Faizi', '081212343445', '$2a$10$jD8Vrr/WcARqvxVxnkbhtufh6pd.yBOciEkMQZSKgmBE3UlfOAj.a', 'rafi');
